...
module.exports = [
  // Unit 5: Family & Daily Life
  {
    ...
    order_num: 60,
    level: 'HSK2',
    grammar_note: 'โครงสร้างประโยคพื้นฐาน:\n主语 + 谓语 + 宾语 (Subject + Verb + Object)\n• 我吃饭。= ฉันกินข้าว\n• 她喝水。= เธอดื่มน้ำ\n\nคำขยายเวลา (อยู่ก่อน verb หรือต้นประโยค):\n• 今天(jīntiān)=วันนี้ · 明天(míngtiān)=พรุ่งนี้\n• 每天(měitiān)=ทุกวัน\n\n在(zài) = กำลัง...อยู่ (แสดง aspect ปัจจุบัน):\n• 我在吃饭。= ฉันกำลังกินข้าวอยู่',
    cultural_note: 'ชีวิตประจำวันจีน — อาหารเช้ามักกิน 包子(bāozi) หรือ 粥(zhōu) ข้างนอกบ้าน คนเมืองจีนส่วนใหญ่ใช้ WeChat Pay/Alipay — ไม่ค่อยใช้เงินสด',
    lessons: [
      {
        ...
        xp_reward: 12,
        exercises: [
          { type: 'multiple_choice', data: { question: "'我的爸爸是医生。' — '的' ในประโยคนี้ทำหน้าที่อะไร?", options: ['แสดงกริยา', 'แสดงความเป็นเจ้าของ', 'คำถาม', 'ปฏิเสธ'], correct: 1 } },
          { type: 'multiple_choice', data: { question: "'我有一个哥哥和两个妹妹。' แปลว่าอะไร?", options: ['ฉันมีพี่ชายหนึ่งคนและน้องสาวสองคน', 'ฉันมีน้องชายหนึ่งคนและน้องสาวสองคน', 'ฉันมีพี่ชายสองคนและน้องสาวหนึ่งคน', 'ฉันมีพี่สาวหนึ่งคนและพี่ชายสองคน'], correct: 0 } },
          { type: 'multiple_choice', data: { question: "จะพูด 'แม่ของฉัน' ในภาษาจีนอย่างไรถูกต้อง?", options: ['妈妈我', '我是妈妈', '我的妈妈', '妈妈的我'], correct: 2 } },
          { type: 'multiple_choice', data: { question: "'他是我的弟弟，不是我的哥哥。' แปลว่าอะไร?", options: ['เขาเป็นพี่ชาย ไม่ใช่น้องชาย', 'เขาเป็นน้องชาย ไม่ใช่พี่ชาย', 'เขาเป็นพ่อ ไม่ใช่พี่ชาย', 'เขาเป็นน้องสาว ไม่ใช่น้องชาย'], correct: 1 } },
  ...
  // Unit 6: Shopping & Food
  {
    ...
    order_num: 80,
    level: 'HSK3',
    grammar_note: 'ช้อปปิ้ง:\n• 多少钱? = ราคาเท่าไร?\n• 太贵了 = แพงเกินไป / 便宜点儿? = ลดได้ไหม?\n• 我要这个。= ฉันเอาอันนี้\n\nเปรียบเทียบ 比(bǐ):\n• A比B+adj: 苹果比香蕉贵。= แอปเปิ้ลแพงกว่ากล้วย\n• A没有B+adj: 他没有我高。= เขาไม่สูงเท่าฉัน\n\nอาหาร: ไม่ต้องใส่ 的 เมื่อสั่ง:\n• 来一碗米饭。= ขอข้าวสักชาม',
    cultural_note: 'ตลาดจีนมักต่อราคาได้ โดยเฉพาะตลาดนัดและร้านเสื้อผ้า — เสนอ 40-50% ของราคาที่บอก แต่ในห้างสรรพสินค้าและร้าน chain ต่อไม่ได้',
    lessons: [
      {
  ...
  // Unit 7: Grammar - Measure Words & Sentence Patterns
  {
    ...
    order_num: 90,
    level: 'HSK3',
    grammar_note: 'ลักษณนาม 量词 (Measure Words):\n• 个(gè) = ทั่วไป: 一个人, 三个苹果\n• 本(běn) = เล่ม: 一本书\n• 杯(bēi) = แก้ว: 一杯水\n• 张(zhāng) = แผ่น: 一张纸\n• 只(zhī) = ตัว(สัตว์เล็ก): 一只猫\n\nโครงสร้าง 把(bǎ) — เน้นผลการกระทำ:\n• 我把书放在桌上。= ฉันวางหนังสือบนโต๊ะ\n\nรูป Passive 被(bèi):\n• 书被他拿走了。= หนังสือถูกเขาเอาไป',
    cultural_note: 'ลักษณนามมีหลายร้อยตัวในจีน แต่ใช้ 个 แทนได้เกือบทุกสถานการณ์ในชีวิตประจำวัน — คนจีนรู้ว่าคุณยังเรียนอยู่และจะไม่แปลกใจ',
    lessons: [
      {
        title: 'ลักษณนาม (量词)',
        order_num: 1,
  ...
  // Unit 8: Advanced Chinese
  {
    ...
    order_num: 120,
    level: 'HSK4',
    grammar_note: '成语 (Chéngyǔ) สำนวน 4 พยางค์:\n• 马到成功 = ประสบความสำเร็จทันที\n• 一石二鸟 = ยิงปืนนัดเดียวได้นกสองตัว\n• 半途而废 = ทำงานค้างคา\n• 亡羊补牢 = แก้ปัญหาสายเกินไป\n\n虽然...但是... = แม้ว่า...แต่...\n既然...就... = เมื่อ(สถานการณ์แล้ว)...ก็...\n\nภาษาธุรกิจ:\n• 合作愉快 = ขอให้ร่วมงานด้วยกันได้ดี\n• 请多关照 = ขอฝากเนื้อฝากตัวด้วย',
    cultural_note: 'การทำธุรกิจกับคนจีน — 关系(guānxi) คือ "connection/network" สำคัญมาก บางครั้งสำคัญกว่าคุณสมบัติ ต้องสร้างความสัมพันธ์ก่อนทำธุรกิจ',
    lessons: [
      {
