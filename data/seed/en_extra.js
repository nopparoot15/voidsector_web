    ...
    lessons: [
      {
        ...
        xp_reward: 15,
        exercises: [
          { type: 'multiple_choice', data: { question: "'Mother' แปลว่าอะไร?", options: ['พ่อ', 'แม่', 'พี่สาว', 'น้องชาย'], correct: 1 } },
          { type: 'multiple_choice', data: { question: "'Brother' แปลว่าอะไร?", options: ['พี่สาว', 'น้องสาว', 'พี่ชาย/น้องชาย', 'ลูกชาย'], correct: 2 } },
          { type: 'multiple_choice', data: { question: "'Grandparents' หมายถึงอะไร?", options: ['พ่อแม่', 'ปู่ย่าตายาย', 'ลุงป้า', 'ลูกหลาน'], correct: 1 } },
      ...
      },
      {
        ...
        xp_reward: 15,
        exercises: [
          { type: 'multiple_choice', data: { question: "'Tall' แปลว่าอะไร?", options: ['เตี้ย', 'สูง', 'อ้วน', 'ผอม'], correct: 1 } },
          { type: 'multiple_choice', data: { question: "'Intelligent' แปลว่าอะไร?", options: ['ขี้เกียจ', 'ขยัน', 'ฉลาด', 'ตลก'], correct: 2 } },
          { type: 'multiple_choice', data: { question: "คำตรงข้ามของ 'young' คือ?", options: ['new', 'old', 'small', 'fast'], correct: 1 } },
    ...
    lessons: [
      {
        ...
        xp_reward: 15,
        exercises: [
          { type: 'multiple_choice', data: { question: "'Hospital' แปลว่าอะไร?", options: ['โรงเรียน', 'โรงพยาบาล', 'โรงแรม', 'ร้านอาหาร'], correct: 1 } },
          { type: 'multiple_choice', data: { question: "'Supermarket' คือที่ใด?", options: ['ธนาคาร', 'ห้องสมุด', 'ซูเปอร์มาร์เก็ต', 'สนามบิน'], correct: 2 } },
      ...
      },
      {
        ...
        xp_reward: 15,
        exercises: [
          { type: 'multiple_choice', data: { question: "'Turn left' หมายความว่าอะไร?", options: ['เลี้ยวขวา', 'เลี้ยวซ้าย', 'ตรงไป', 'หยุด'], correct: 1 } },
          { type: 'multiple_choice', data: { question: "'Go straight' หมายความว่าอะไร?", options: ['หันกลับ', 'เลี้ยวซ้าย', 'ตรงไป', 'เลี้ยวขวา'], correct: 2 } },
