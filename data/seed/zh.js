  ...
  units: [
    {
      ...
      order_num: 1,
      level: 'HSK1',
      grammar_note: 'ภาษาจีนกลาง (普通话 Pǔtōnghuà) มีวรรณยุกต์ 4 เสียง + เสียงกลาง:\n\n• 1声 ā = เสียงระดับ (สูงคงที่)\n• 2声 á = เสียงขึ้น (เหมือนถาม?)\n• 3声 ǎ = เสียงลง-ขึ้น (ต่ำแล้วขึ้น)\n• 4声 à = เสียงลง (หนักแน่น)\n• 轻声 a = เสียงกลาง (เบา ไม่มีเครื่องหมาย)\n\nตัวอักษรจีนแต่ละตัวมีเสียงเดียว ความหมายต่างกัน:\n• 妈(mā)=แม่, 马(mǎ)=ม้า, 骂(mà)=ด่า',
      cultural_note: 'อักษรจีนแบ่งเป็น 简体字 (ตัวย่อ — จีนแผ่นดินใหญ่/สิงคโปร์) และ 繁體字 (ตัวเต็ม — ไต้หวัน/ฮ่องกง)\nHSK ใช้ตัวย่อ',
      lessons: [
        {
          title: 'คำพื้นฐาน',
          order_num: 1,
    ...
    },
    {
      ...
      order_num: 2,
      level: 'HSK1',
      grammar_note: 'คำทักทายพื้นฐาน:\n• 你好 (nǐ hǎo) = สวัสดี\n• 您好 (nín hǎo) = สวัสดี (สุภาพ)\n• 谢谢 (xièxie) = ขอบคุณ\n• 不客气 (bú kèqi) = ยินดี\n• 对不起 (duìbuqǐ) = ขอโทษ\n• 没关系 (méi guānxi) = ไม่เป็นไร\n\nแนะนำตัว: 我叫[ชื่อ]。我是泰国人。\n(Wǒ jiào... Wǒ shì Tàiguó rén.)',
      cultural_note: 'คนจีนทักทายด้วย "你吃了吗?" (กินข้าวหรือยัง?) — ไม่ได้ถามจริง แต่แสดงความห่วงใย เหมือน "How are you?" ของฝรั่ง',
      lessons: [
        {
    ...
    },
    {
      ...
      order_num: 3,
      level: 'HSK1',
      grammar_note: 'ตัวเลข 1-10:\n一(yī) 二(èr) 三(sān) 四(sì) 五(wǔ) 六(liù) 七(qī) 八(bā) 九(jiǔ) 十(shí)\n\nหลักสิบ: 十一=11, 二十=20, 二十五=25, 一百=100\n\nถามราคา: 多少钱? (Duōshǎo qián?) = ราคาเท่าไร?\nบอกราคา: 五块 (Wǔ kuài) = 5 หยวน\nหน่วยเงิน: 块/元(yuán) > 毛(máo) > 分(fēn)',
      cultural_note: 'เลข 8 (八 bā) ถือว่าโชคดีในวัฒนธรรมจีน เพราะออกเสียงใกล้เคียงกับ 发(fā)=รวย ราคาสินค้าจีนมักลงท้าย 8 และหมายเลขทะเบียนรถที่มี 8 มีราคาสูง',
      lessons: [
        {
          title: '1 ถึง 5',
          order_num: 1,
    ...
    },
    {
      ...
      order_num: 4,
      level: 'HSK2',
      grammar_note: 'คำเรียกครอบครัว:\n• 爸爸(bàba)=พ่อ · 妈妈(māma)=แม่\n• 哥哥(gēge)=พี่ชาย · 姐姐(jiějie)=พี่สาว\n• 弟弟(dìdi)=น้องชาย · 妹妹(mèimei)=น้องสาว\n• 爷爷(yéye)=ปู่ · 奶奶(nǎinai)=ย่า\n\n的 (de) = แสดงความเป็นเจ้าของ:\n我的妈妈 = แม่ของฉัน\n他的书 = หนังสือของเขา',
      cultural_note: 'ครอบครัวจีนแยกคำเรียกญาติฝั่งพ่อและฝั่งแม่อย่างละเอียด เช่น ปู่-ย่า(ฝั่งพ่อ) ≠ 外公-外婆(ฝั่งแม่) — แสดงถึงความสำคัญของสายเลือด',
      lessons: [
        {
          title: 'พ่อแม่',
          order_num: 1,
